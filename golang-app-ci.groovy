...
node('worker0') {
    ...
    env.HOME = "${WORKSPACE}"
    env.CONTAINER_IMAGE = 'docker.io/calvarado2004/golang-app'
    env.GIT_PROJECT_CI = 'github.com/calvarado2004/golang-app-ci.git'
    env.GIT_PROJECT_CD = 'github.com/calvarado2004/golang-app-cd.git'
    ...
    stage ('Modify Golang App image on Deployment') {
